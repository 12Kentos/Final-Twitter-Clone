...
export default function Widgets({ newsResults, randomUsersResults }) {
  ...
  return (
    <div className="xl:w-[700px] hidden lg:inline ml-8 space-y-5">
      ...
      <div className="text-gray-700 space-y-3 bg-gray-100 rounded-xl pt-2 w-[95%] xl:w[95%]">
        ...
        <button
          className="text-sky-500 pl-4 pb-3 hover:text-sky-600"
      ...
      <div className="sticky top-16 text-gray-700 space-y-3 bg-gray-100 rounded-xl pt-2 w-[95%] xl:w[95%]">
